...
description: Use when auditing GitHub Actions, Bitbucket Pipelines, GitLab CI, CircleCI, Azure Pipelines, Jenkins, Buildkite, n8n, Dify, Flowise, Langflow, MCP, Node-RED, Make, Pipedream, Airflow, browser automation, or AI automation for AWI001-AWI010 risks.
---

# agentic-workflow-guard-auditor

## Project
Static security scanner for AI automation workflows across GitHub Actions, Bitbucket Pipelines, GitLab CI, CircleCI, Azure Pipelines, Jenkins, Buildkite, n8n, Dify, Flowise, Langflow, MCP configs, browser traces, Airflow DAGs, and low-code workflow exports.
...
- Use npm run release:prepare -- --version 1.0.0-rc.1 --dry-run before releases to preview package version and release-tag changes
...
- release-prepare: `npm run release:prepare -- --version 1.0.0-rc.1 --dry-run`
