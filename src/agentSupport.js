...
export const supportedAgents = [
  ...
  },
  {
    ...
    outputs: ["mcp/resources/agentic-workflow-guard.resources.json", "rules/marketplace.json", "rules/registry.json", "rules/community/*.json", "benchmarks/fixtures.json", "benchmarks/corpus.json", "schemas/*.json", "docs/demos.md", "docs/playbooks/*.md"],
