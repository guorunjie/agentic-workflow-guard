export const rules = {
  AWI001: {
    ...
    risk: "Issue, pull request, merge request, branch, discussion, comment, or commit text from GitHub Actions, GitLab CI, CircleCI, Azure Pipelines, Jenkins, or Buildkite can contain prompt-injection instructions that influence an agent.",
