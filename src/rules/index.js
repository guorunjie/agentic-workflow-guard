export const rules = {
  AWI001: {
    ...
    risk: "Issue, pull request, merge request, branch, discussion, comment, or commit text from GitHub Actions, Bitbucket Pipelines, GitLab CI, Travis CI, Drone CI, CircleCI, Azure Pipelines, Jenkins, or Buildkite can contain prompt-injection instructions that influence an agent.",
