...
const corePlatforms = ["github-actions", "bitbucket-pipelines", "gitlab-ci", "circleci", "azure-pipelines", "jenkins", "buildkite", "n8n", "mcp", "activepieces", "dify", "flowise", "langflow", "zapier", "make", "pipedream", "node-red", "airflow", "browser-use", "playwright", "skyvern"];
...
export const communityRulePacks = [
  ...
  },
  {
    ...
    version: packageVersion,
    description: "Focused CI pipeline rule pack for Bitbucket Pipelines, GitLab CI, CircleCI, Azure Pipelines, Jenkins, and Buildkite agent jobs.",
    publisher: "guorunjie",
    license: "MIT",
    homepage: repository,
    compatibility: {
    ...
    platforms: ["bitbucket-pipelines", "gitlab-ci", "circleci", "azure-pipelines", "jenkins", "buildkite"],
