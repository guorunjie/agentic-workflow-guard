...
export const mcpResourcePack = {
  ...
  resources: [
    ...
    },
    {
      ...
      description: "How to reduce prompt injection, shell sink, token, context, service connection, and credential risks in Bitbucket Pipelines, GitLab CI, Travis CI, Drone CI, CircleCI, Azure Pipelines, Jenkins, and Buildkite agent jobs.",
      mimeType: "text/markdown",
