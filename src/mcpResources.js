...
export const mcpResourcePack = {
  ...
  resources: [
    ...
    {
      uri: "awg://schemas/config",
      name: "config-schema",
      title: "Agentic Workflow Guard Config Schema",
      description: "Stable JSON Schema for .awg.yml, .awg.yaml, and .awg.json repository config.",
      mimeType: "application/schema+json",
      path: "schemas/agentic-workflow-guard-config.schema.json",
      annotations: { audience: ["assistant", "user"], priority: 0.95 }
    },
    {
    ...
    },
    {
      ...
      description: "How to reduce prompt injection, shell sink, token, context, service connection, and credential risks in Bitbucket Pipelines, GitLab CI, Travis CI, Drone CI, TeamCity, Harness CI/CD, Tekton Pipelines, Argo Workflows, AWS CodeBuild, Google Cloud Build, CircleCI, Azure Pipelines, Jenkins, and Buildkite agent jobs.",
      mimeType: "text/markdown",
