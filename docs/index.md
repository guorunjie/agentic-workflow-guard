...
- [v1.0 Readiness](v1-readiness.md): release gates, blockers, and final cut steps for v1.0.
- [Roadmap](../ROADMAP.md): post-1.0 platform coverage, rule marketplace, benchmark, and agent-skill milestones.
...
- [Bitbucket Pipelines, GitLab CI, Travis CI, Drone CI, TeamCity, Harness CI/CD, Tekton Pipelines, Argo Workflows, AWS CodeBuild, Google Cloud Build, CircleCI, Azure Pipelines, Jenkins, and Buildkite](playbooks/ci-pipelines.md)
